...
//       setHasScrolled(progress > 0.015);
//       setStage(progress < 0.34 ? 'Assembled' : progress < 0.68 ? 'In motion' : 'Unleashed');
//     };
...
//         const nextTime = Math.min(video.duration, Math.max(0, currentProgressRef.current * video.duration));
//         if (Math.abs(video.currentTime - nextTime) > 0.003) video.currentTime = nextTime;
//       }
...
//       <section id="experience" className="scrub-stage" style={{ height: `${SCRUB_SPACE}vh` }} aria-label="Scroll-controlled sneaker showcase">
//         <video
//           ref={videoRef}
...
//         <div className={`intro-copy ${hasScrolled ? 'is-hidden' : ''}`}>
//           <span className="eyebrow">Nike / Air — 01</span>
//           <h1>Designed to move.</h1>
//           <span className="scroll-prompt">Scroll to reveal <span className="scroll-arrow">↓</span></span>
//         </div>
//         <div className={`story-copy ${hasScrolled ? 'is-active' : ''}`} aria-hidden="true">
//           <span className="story-kicker">The future of flight</span>
//           <span className="story-title">Every layer<br />has a purpose.</span>
//           <span className="story-stage">{stage}</span>
//         </div>
//         <div className="video-caption" aria-hidden="true">
//           <span>Scroll controlled film</span>
//           <span>01 / 01</span>
//         </div>
//         {!isReady && <div className="loading-mark" aria-label="Loading" />}
//       </section>
//       <section id="story" className="anchor-section" aria-hidden="true" />
//       <section id="craft" className="anchor-section" aria-hidden="true" />
//       <div
//         className={`cosmic-cursor ${cursor.visible ? 'is-visible' : ''}`}
